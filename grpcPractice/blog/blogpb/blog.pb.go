...
type ListBlogRequuest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ListBlogRequuest) Reset() {
	*x = ListBlogRequuest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListBlogRequuest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBlogRequuest) ProtoMessage() {}

func (x *ListBlogRequuest) ProtoReflect() protoreflect.Message {
	mi := &file_blog_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBlogRequuest.ProtoReflect.Descriptor instead.
func (*ListBlogRequuest) Descriptor() ([]byte, []int) {
...
var file_blog_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x62, 0x6c, 0x6f, 0x67, 0x49, 0x64, 0x22, 0x12, 0x0a, 0x10, 0x4c, 0x69,
	0x73, 0x74, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x75, 0x65, 0x73, 0x74, 0x22, 0x32,
	0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x1e, 0x0a, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0a, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x04, 0x62, 0x6c,
	0x6f, 0x67, 0x32, 0xc9, 0x02, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x12, 0x3c, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x67, 0x12, 0x16, 0x2e, 0x62,
	...
	0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x08,
...
var file_blog_proto_goTypes = []interface{}{
	...
	(*ListBlogRequuest)(nil),   // 9: blog.ListBlogRequuest
...
var file_blog_proto_depIdxs = []int32{
	...
	9,  // 10: blog.BlogService.ListBlog:input_type -> blog.ListBlogRequuest
...
type BlogServiceClient interface {
	...
	ListBlog(ctx context.Context, in *ListBlogRequuest, opts ...grpc.CallOption) (BlogService_ListBlogClient, error)
}
...
func (c *blogServiceClient) ListBlog(ctx context.Context, in *ListBlogRequuest, opts ...grpc.CallOption) (BlogService_ListBlogClient, error) {
...
type BlogServiceServer interface {
	...
	ListBlog(*ListBlogRequuest, BlogService_ListBlogServer) error
}
...
func (*UnimplementedBlogServiceServer) ListBlog(*ListBlogRequuest, BlogService_ListBlogServer) error {
